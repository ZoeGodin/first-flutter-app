...
import 'package:my_library/models/diet_model.dart';
...
// 19:47
    ...
    return Scaffold(
      ...
      body: Column( //same as flex column
        ...
        children: [ //display children of xolumn (will be in order)
          textField(),
          SizedBox(height: 40,), //creates distance between elements
          _categorySection(),
          SizedBox(height: 40,),
          _dietSection()
        ],
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              diets[index].viewIsSelected ? Color(0xff0DCEFF) : Colors.transparent,
  ...
  Column _categorySection() {
    return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Padding( //wraps the children in padding
              padding: const EdgeInsets.only(left:20), // creates padding only on left side 
              child: Text(
                'Category',
                style: TextStyle(
                  color: Colors.black,
